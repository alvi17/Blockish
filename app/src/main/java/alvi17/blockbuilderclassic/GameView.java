...
import alvi17.blockbuilderclassic.model.AI;
import alvi17.blockbuilderclassic.model.Board;
import alvi17.blockbuilderclassic.model.Game;
import alvi17.blockbuilderclassic.model.Move;
import alvi17.blockbuilderclassic.model.Piece;
import alvi17.blockbuilderclassic.model.Square;
...
public class GameView extends FrameLayout {
	...
	public GameView(Context context) {
		...
		setLayoutParams( new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT, Gravity.TOP));
...
//				addView( new PieceUI(context, piece, i, 20+2) );
    ...
    if (extraMenu!=null && !ViewConfiguration.get(context).hasPermanentMenuKey()) {
      ...
      extraMenu.setOnClickListener( new OnClickListener() {
		...
		iView.setLayoutParams(new LayoutParams(150, 150, Gravity.CENTER_VERTICAL|Gravity.CENTER_HORIZONTAL));
		addView(iView);
